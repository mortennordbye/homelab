...
export const interests: Interest[] = [
  {
    title: "Fitness",
    icon: "fitness",
    body: "I train five times a week. Running, swimming, cycling and light weights, mostly. It keeps me sharp at work and makes the long days easier to handle. A lot of good conversations happen in the gym too.",
  },
  {
    title: "Homelabbing",
    icon: "homelab",
