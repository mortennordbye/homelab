---
title: "Healthcare Application: RHEL7 → RHEL9 Migration"
slug: "healthcare-rhel-migration"
kind: "professional"
client: "Confidential healthcare provider"
role: "Migration & automation lead"
period: "2024 — 2025"
...
outcomes:
  ...
  - "Logging consolidated through Filebeat → Logstash, giving operations a single pane of glass."
...
A patient-facing application was running on RHEL7. It was past its useful life and close to losing vendor support. The customer needed it on **RHEL9**, with stronger logging, a tighter security perimeter and automation good enough that the next migration would not take as long.
