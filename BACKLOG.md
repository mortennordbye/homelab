...
- **Why deferred:** The rules added on 2026-09-26 need a full 7d window before the query shows whether they drained it, and the flows above need Hubble data before a rule can be written for them. Getting one wrong takes an app off the network once enforcement is on.
